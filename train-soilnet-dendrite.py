...
#
# CSV format expected (from your converter):
...
#     --out_dir   runs/mobilenetv2_dendrite \
#     --epochs 20 --batch_size 64 --lr 1e-4 --wd 1e-4 --img_size 224 \
...
# ==== PerforatedAI (this matches your installed modules) ====
from perforatedai import globals_perforatedai as PBG
from perforatedai import utils_perforatedai   as PBU
...
def main():
    ...
    # Register optimizer/scheduler with the tracker and let it build the instances
